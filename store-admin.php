<div class="wrap">
    <h2>
        Create your
        <a class="sellfy-logo" href="https://sellfy.com/?utm_source=api_wp" target="_blank">
            <img src="<?php echo plugins_url( '/images/sellfy-profile-logo.png', __FILE__ )?>" />
        </a>
        store page
    </h2>
    ...
    <h3>Account info:</h3>
        <a class="button-primary" href="https://sellfy.com/signup/?utm_source=api_wp" target="_blank">Create Sellfy.com account</a>
        <a class="button-secondary" href="https://sellfy.com/login/?utm_source=api_wp" target="_blank">I already have a Sellfy.com account</a>
    </div>
    <div class="sellfy-one-step">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description">You can find your Sellfy username in <a href="https://sellfy.com/user/#/settings/account" target="_blank">"Account settings"</a></p>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
